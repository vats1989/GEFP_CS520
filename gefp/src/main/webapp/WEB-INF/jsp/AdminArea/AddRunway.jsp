...
<html>
<head><title>Golden Eagle Flight Plan Add Runway</title>
...
<tr>
	<td align="left"> Runway Name: </td> 
	<td> <form:input path="runway_name" placeholder="Enter Runway Name"/></td> 
</tr> 
